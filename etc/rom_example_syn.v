...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="rom1.mif" NUMWORDS_A=8 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=3 WIDTH_BYTEENA_A=1 WIDTHAD_A=3 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "rom1.mif",
	...
	defparam
		...
		ram_block1a_1.init_file = "rom1.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "rom1.mif",
	...
	assign
		...
		q_a = {wire_ram_block1a_2portadataout[0], wire_ram_block1a_1portadataout[0], wire_ram_block1a_0portadataout[0]};
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: MGL_INTERNAL_WARNING: (Invalid line found in memory file.  Invalid line -- 		[101..111]=111; -- found in file rom1.mif)  ");
		$display("Warning: Memory initialization file rom1.mif is not found. This may result in inconsistent simulation results.");
	end
endmodule //rom_example_altsyncram
//VALID FILE
...
`endif
	...
	rom_example_altsyncram	rom_example_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
